...
1""".split("\n")
    ...
    def test_check_spaces(self):
        ...
        Solver().check_spaces(
            mask, Line(
                size=4, idx=4, blocks=[Block(
                    start=0, end=3, length=0
                )]
            )
        )
        self.assertEqual(bytearray([WHITE] * 4), mask)
    ...
    def test_mark_white_cell_at_boundary(self):
        ...
        blocks = [
            Block(
                start=1, end=8, length=4
            ), Block(
                start=5, end=8, length=2
            ), Block(
                start=3, end=8, length=1
            ), Block(
                start=0, end=8, length=1
            )
        ]
    ...
    def test_covering_blocks(self):
        blocks = [
            Block(
                start=1, end=10, length=4
            ), Block(
                start=6, end=9, length=4
            ), Block(
                start=3, end=7, length=4
            ), Block(
                start=2, end=4, length=4
            )
        ]
    ...
    def test_fill_cells_based_on_boundary(self):
        ...
        blocks = [
            Block(
                start=0, end=7, length=3
            ), Block(
                start=4, end=12, length=4
            )
        ]
        mask = bytearray(
        ...
        blocks = [
            Block(
                start=5, end=12, length=3
            ), Block(
                start=0, end=8, length=4
            )
        ]
        mask = bytearray(
    ...
    def test_mark_boundary_if_possible(self):
        ...
        blocks = [
            Block(
                ...
                start=2, end=6, length=2
            ), Block(
                start=5, end=9, length=2
            ), Block(
                start=8, end=13, length=3
            )
        ]
    ...
    def test_check_meta_consistency(self):
        meta = Line(
            ...
            blocks=[
                Block(
                    ...
                    start=0, end=9, length=3
                ), Block(
                    start=0, end=9, length=1
                )
            ]
        )
        ...
        expected = Line(
            ...
            blocks=[
                Block(
                    ...
                    start=3, end=7, length=3
                ), Block(
                    start=7, end=9, length=1
                )
            ]
        )
        ...
        meta = Line(
            ...
            blocks=[
                Block(
                    start=0, end=7, length=2
                ), Block(
                    start=2, end=8, length=3
                ), Block(
                    start=6, end=9, length=1
                )
            ]
        )
        expected = Line(
    ...
    def test_narrow_boundaries(self):
        mask = bytearray(
            [UNKNOWN] * 4 + [BLACK] * 3 + [UNKNOWN] * 4 + [BLACK] + [UNKNOWN] *
            2
        )
        meta = Line(
            size=14,
            ...
            blocks=[
                Block(
                    start=0, end=8, length=3
                ), Block(
                    start=4, end=11, length=2
                ), Block(
                    start=7, end=13, length=1
                )
            ]
        )
        expected = Line(
        ...
        meta = Line(
            ...
            blocks=[
                Block(
                    start=0, end=10, length=2
                ), Block(
                    start=0, end=10, length=3
                ), Block(
                    start=4, end=10, length=1
                )
            ]
        )
        expected = Line(
        ...
        meta = Line(
            ...
            blocks=[
                Block(
                    ...
                    start=2, end=10, length=4
                ), Block(
                    start=4, end=10, length=2
                )
            ]
        )
        expected = Line(
