    ...
    for block_idx, block in enumerate(meta.blocks):
        ...
        for black_segment in [
            ...
            if (
                ...
                and black_segment.end + 2 <= meta.size - block.length
            ...
            if (
                ...
                # and new start would be within boundaries
                and black_segment.start - 1 - block.length >= 0
                # and it is worth the change
